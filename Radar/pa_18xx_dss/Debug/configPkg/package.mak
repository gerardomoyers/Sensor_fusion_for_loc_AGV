...
ti.targets.elf.C674.rootDir ?= C:/ti/ti-cgt-c6000_8.3.3
...
.dlls,e674 .dlls: dss_pa.pe674

-include package/cfg/dss_pa_pe674.mak
-include package/cfg/dss_pa_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dss_pa_pe674.dep
endif
dss_pa.pe674: package/cfg/dss_pa_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
dss_pa.pe674 package/cfg/dss_pa_pe674.c: .libraries,e674
endif

package/cfg/dss_pa_pe674.c package/cfg/dss_pa_pe674.h package/cfg/dss_pa_pe674.xdl: override _PROG_NAME := dss_pa.xe674
package/cfg/dss_pa_pe674.c: package/cfg/dss_pa_pe674.cfg
package/cfg/dss_pa_pe674.xdc.inc: package/cfg/dss_pa_pe674.xdl
package/cfg/dss_pa_pe674.xdl package/cfg/dss_pa_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/dss_pa_pe674.cfg
	-$(RM) package/cfg/dss_pa_pe674.dep
	-$(RM) package/cfg/dss_pa_pe674.c
	-$(RM) package/cfg/dss_pa_pe674.xdc.inc

clean,e674::
	-$(RM) dss_pa.pe674
.executables,e674 .executables: dss_pa.xe674

dss_pa.xe674: |dss_pa.pe674

-include package/cfg/dss_pa.xe674.mak
dss_pa.xe674: package/cfg/dss_pa_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/dss_pa_pe674.oe674   package/cfg/dss_pa_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
dss_pa.xe674: export C_DIR=
dss_pa.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
dss_pa.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

dss_pa.test test,e674 test: dss_pa.xe674.test

dss_pa.xe674.test:: dss_pa.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dss_pa.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dss_pa.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,dss_pa.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
dss_pa_pe674.oe674,copy : package/cfg/dss_pa_pe674.oe674
dss_pa_pe674.se674,copy : package/cfg/dss_pa_pe674.se674
